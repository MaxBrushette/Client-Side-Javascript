...
let person = {
    ...
    age: 16,
    gender: "Male",
    interests: ["swimming", "writing", "coding"],
    greetings: function(){
        // Hey, this is Priyansh Thakar!
        alert(`Hey, this is ${this.name.firstName} ${this.name.lastName}!`);
    },
    bio: function(){
        // The interests of Priyansh Thakar, of age: 16, of gender: Male, are -interests-.
...
This will become much clearer later in the course. Create two new objects, each with a name, 
and a function that outputs the name */
// let name = "ABC";
let person1 = {
    name: "Person1",
    hello: function(){
