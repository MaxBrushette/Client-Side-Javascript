...
let myArray = ["String", true, 100, [5, "Hiii"]];
...
output.textContent = `mnyArray has ${myArray.length} elements inside of it.`;
...
output.textContent = `The last team in the array is ${orig6Array[orig6Array.at(-1)]}`;
...
orig6Array.splice(3, 0, "Edmondton Oilers", "Florida Panthers");
